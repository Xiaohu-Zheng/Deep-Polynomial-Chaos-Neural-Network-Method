...
class CalculatePCELoss(nn.Module):
    ...
    def __init__(self, order, order_mat, pc='apc', p_orders=None, sparse_basis=None):
    ...
    def forward(self, x, y, c):
        y_pred = dPC.deep_pce_fun(x, c, self.order, self.order_mat, self.pc, self.p_orders, self.sparse_basis)
